  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="resourceTable"
        ...
        <el-table-column label="资源名称" align="center">
          <template slot-scope="scope">{{scope.row.permissions}}</template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form :model="resource"
        ...
        <el-form-item label="资源名称：">
          <el-input v-model="resource.permissions" style="width: 250px"></el-input>
        </el-form-item>
        <el-form-item label="资源路径：">
...
<script>
  import {fetchList,createResource,updateResource,deleteResource} from '@/api/permission';
